...
export const Upload = ({file, setFile, content='Upload content', classname, onError ,allowedExtensions}: uploadProps) => {
  ...
  return (
    <Box>
      <Box className={cn('border rounded-md p-2 flex items-center justify-between w-[10.93rem] h-[2.75rem]', 
      ...
      {file ? (
        ...
        <Grid className='flex items-center justify-center h-full w-full'>
          <Button onClick={handleUploadClick} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap:1, color: 'var(--primary-main)', textTransform: 'none' }}>
