...
interface DecisionModalProps {
  ...
  isLoading?: boolean
  buttonTextColor?:'primary' | 'secondary' | 'success' | 'error' | 'warning' | 'info' | 'light' | 'dark' | undefined;
}

const DecisionModal = ({open, onClose, titleText, descriptionText, buttonText, cancelButtonText, onClick, classname, cancelClassname,buttonTextColor,isLoading}: DecisionModalProps) => {
        ...
        <div className='top-0 left-0 w-full h-full bg-opacity-80 flex items-center justify-center'>
            <div className='relative flex flex-col gap-5 h-[184px] w-[600px] bg-text-hint rounded-md p-6'>
                <div className='flex justify-between'>
                    ...
                    <div className='title1Bold text-text-primary'>
                        {titleText}
                    </div>
                ...
                <div className='bodyRegular text-text-primary'>
                    {descriptionText}
                </div>
