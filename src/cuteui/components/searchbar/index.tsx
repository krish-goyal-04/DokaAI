...
export const Search = ({
  ...
  return (
    <div
      ...
      className={cn(
        "relative w-auto flex items-center bg-text-hint",
        props.className
      )}
    >
      <div className="absolute inset-y-0 left-0 pl-2 flex items-center pointer-events-none">
        {(hasDropdown && isLoading) ? (<div className="scale-75"><Loader /></div>) : (<Image src={SearchIcon} alt="icon" className="mx-2 h-6 w-6" />)}
